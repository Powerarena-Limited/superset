...
export interface DistplotStylesProps {
  height: number;
  width: number;
...
interface DistplotCustomizeProps {
  headerText: string;
}

export type DistplotQueryFormData = QueryFormData &
  DistplotStylesProps &
  DistplotCustomizeProps;

export type DistplotProps = DistplotStylesProps &
  DistplotCustomizeProps & {
